...
def process_telegram_data(proxy_file: str, telegram_file: str, seq_start: int, seq_end: int) -> List[Dict]:
    """
...
if __name__ == "__main__":
    ...
    # 调用函数
    result = process_telegram_data("proxy.json", "telegram.json", 1, 3)
    for item in result:
        print(item)